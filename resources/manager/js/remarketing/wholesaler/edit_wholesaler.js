...
(function($){
	...
	$('#login_account').keyup(function()
    {
		...
		$.post('/manager/remarketing/wholesaler/action/session/check_edit_loginaccount_duplicate', data, function(resultObj)
        {
            showResultToastr({
                'resultObj': resultObj
            });
	...
	$('#edit_wholesaler').click(function()
    {
		...
		$.post('/manager/remarketing/wholesaler/action/session/edit', data, function(resultObj)
        {
            showResultToastr({
                'resultObj': resultObj
            });
