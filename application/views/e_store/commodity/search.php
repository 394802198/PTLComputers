                ...
                <div class="col-md-12" style="background:#FFF;">
                    ...
                    <?php if( count( $ciPagination->content ) > 0 ){ ?>
                        <div class="col-md-12" style="text-align:center; padding:20px 0;">
                            <div class="alert alert-info text-right" role="alert" style="font-weight:bold; font-style:oblique;">
                                Current Page Total: <?php echo count( $ciPagination->content ); ?> <span class="xs-hide">|</span> Found Total: <?php echo $ciPagination->total_searched_rows; ?>
                            </div>
                            <?php echo urldecode( $this->pagination->create_links() ); ?>
                        </div>
                    <?php } ?>
                    ...
                    <ul style="padding:20px 0;">
                        ...
                        <?php if( count( $ciPagination->content ) > 0 ){ ?>
                            ...
                            {
                                $keywordParam .= '&keyword=' . $_GET['keyword'];
                            }
                            ?>
                            <?php foreach( $ciPagination->content as $index=>$commodity ) { ?>
                                ...
                                <li class="text-center commodity-list">
                                    <div class="col-md-4">
                                        <a href="<?php echo ROOT_PATH ?>/e_store/commodity/get_by/e_store_sku/<?php echo $commodity->e_store_sku .'?'. $typeParam . $manufacturerParam . $priceRangeParamAppend . $keywordParam ?>">
                                    ...
                                    <div class="col-md-6" style="padding:10px 0;">
                                        <a href="<?php echo ROOT_PATH ?>/e_store/commodity/get_by/e_store_sku/<?php echo $commodity->e_store_sku .'?'. $typeParam . $manufacturerParam . $priceRangeParamAppend . $keywordParam ?>" style="color:#c64b4b; font-weight:bold;">
                                    ...
                                    <span class="text-danger" style="font-weight:bold; font-style:oblique; <?php echo $commodity->inventory['stock'] > 0 ? '' : 'color:#c8c8c8; text-decoration:line-through;' ?>">
                                        ...
                                        <div class="col-md-12" style="margin-top:20px;">
                                            <a href="javascript:void(0);" data-on-click="add_to_cart" data-commodity-id="<?php echo $commodity->id ?>" data-e-store-sku="<?php echo $commodity->e_store_sku ?>" <?php echo $commodity->inventory['stock'] > 0 ? '' : 'disabled' ?> class="btn btn-xs" style="background:#dcf24a; color:#FFF;"data-toggle="tooltip" data-placement="right" data-original-title="To Cart">
