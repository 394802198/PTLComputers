                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input type="hidden" id="receiver_address_id" value="<?php echo $customerReceiverAddress['id'] ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <select id="is_default" class="form-control" style="border-color:#4cae4c;">
                            ...
                            <div class="input-group">
                                ...
                                <select id="shipping_area_id" class="form-control" style="border-color:#4cae4c;">
                                    ...
                                    <?php foreach( $courierShippingAreas as $courierShippingArea ){ ?>
                                        <?php if( $customerReceiverAddress['shipping_area_id'] == $courierShippingArea->id ) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input type="text" id="receiver_name" value="<?php echo $customerReceiverAddress['receiver_name'] ?>" class="form-control" placeholder="*" style="border-color:#4cae4c;" data-from-customer="<?php echo $_SESSION['customer']['first_name'] . ' ' . $_SESSION['customer']['last_name'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input type="text" id="receiver_phone" value="<?php echo $customerReceiverAddress['receiver_phone'] ?>" class="form-control" placeholder="*" style="border-color:#4cae4c;" data-from-customer="<?php echo $_SESSION['customer']['fixed_phone'] != '' ? $_SESSION['customer']['fixed_phone'] : $_SESSION['customer']['mobile_phone'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                ...
                                <input type="text" id="receiver_address" value="<?php echo $customerReceiverAddress['receiver_address'] ?>" class="form-control" placeholder="*" style="border-color:#4cae4c;" data-from-customer="<?php echo $_SESSION['customer']['address'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input type="text" id="receiver_email" value="<?php echo $customerReceiverAddress['receiver_email'] ?>" class="form-control" placeholder="" style="border-color:#4cae4c;" data-from-customer="<?php echo $_SESSION['customer']['email'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input type="text" id="receiver_country" value="<?php echo $customerReceiverAddress['receiver_country'] ?>" class="form-control" style="border-color:#4cae4c;" data-from-customer="<?php echo $_SESSION['customer']['country'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input type="text" id="receiver_province" value="<?php echo $customerReceiverAddress['receiver_province'] ?>" class="form-control" style="border-color:#4cae4c;" data-from-customer="<?php echo $_SESSION['customer']['province'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input type="text" id="receiver_city" value="<?php echo $customerReceiverAddress['receiver_city'] ?>" class="form-control" style="border-color:#4cae4c;" data-from-customer="<?php echo $_SESSION['customer']['city'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input type="text" id="receiver_post" value="<?php echo $customerReceiverAddress['receiver_post'] ?>" class="form-control" style="border-color:#4cae4c;" data-from-customer="<?php echo $_SESSION['customer']['post'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <a class="btn btn-xs btn-success pull-right" id="edit_receiver_address">Edit Receiver Address</a>
                    </div>
                </form>
...
<!-- BEGIN CUSTOMIZED LIB -->
<script src="/resources/e_store/js/customer/receiver_address/edit.js"></script>
<!-- END CUSTOMIZED LIB -->