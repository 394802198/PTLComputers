				...
				<div class="panel panel-success">
					<div class="panel-heading">
                        <ol class="breadcrumb" style="margin: 0;">
                            ...
                            <li><a href="/manager/warehouse/product/type/view" class="text-success">Product Type</a></li>
						...
						<div class="panel-body">
							...
							<div class="form-group">
                                <div class="col-md-10 col-md-offset-2">
                                    <a id="add_type" class="btn btn-success btn-lg">Save</a>
...
<script src="/resources/manager/js/warehouse/product/type/add_type.js"></script>
<!-- END CUSTOMIZED LIB -->
