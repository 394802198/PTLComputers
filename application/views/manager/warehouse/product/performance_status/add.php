				...
				<div class="panel panel-success">
					<div class="panel-heading">
                        <ol class="breadcrumb" style="margin: 0;">
                            ...
                            <li class="active">Add Performance Status</li>
                        </ol>
					</div>
						...
						<div class="panel-body">
							...
							<div class="form-group">
                                <div class="col-md-10 col-md-offset-2">
                                    <a id="add_performance_status" class="btn btn-success btn-lg">Save</a>
...
<script src="/resources/manager/js/warehouse/product/performance_status/add_performance_status.js"></script>
<!-- END CUSTOMIZED LIB -->
