			...
			<div class="panel panel-success">
				<div class="panel-heading">
                    <ol class="breadcrumb" style="margin: 0;">
                        ...
                        <li class="active">Product Manufacturer</li>
                        <li class="pull-right" id="breadcrumb-li">
                            <a href="/manager/warehouse/product/manufacturer/add" class="btn btn-success btn-xs">
				...
				<table class="table">
					...
					<tbody>
						...
						<tr class="">
							<td>&nbsp;</td>
							<td>
								<a href="/manager/warehouse/product/manufacturer/edit/id/<?php echo $manufacturer->id ?>" class="btn btn-xs btn-success">
...
<script>
    ...
    $('#deleteManufacturerConfirm').click(function()
    {
        ...
        $.post('/manager/warehouse/product/manufacturer/action/session/delete', data, function(resultObj)
        {
            showResultToastr({
                'resultObj': resultObj,
