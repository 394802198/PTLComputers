						...
						<div class="panel-body">
							...
							<div class="form-group">
								<div class="col-md-12 col-md-offset-2">
									<a id="add_product_status" class="btn btn-success btn-lg">Save</a>
...
<script src="/resources/manager/js/warehouse/product/product_status/add_product_status.js"></script>
<!-- END CUSTOMIZED LIB -->
