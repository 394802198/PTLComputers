				...
				<div class="panel panel-success">
					<div class="panel-heading">
                        <ol class="breadcrumb" style="margin: 0;">
                            ...
                            <li><a href="/manager/warehouse/commodity/manufacturer/view" class="text-success">Commodity Manufacturer</a></li>
						...
						<div class="panel-body">
							...
							<div class="form-group">
                                <div class="col-md-10 col-md-offset-2">
                                    <a id="add_manufacturer" class="btn btn-success btn-lg">Save</a>
...
<script src="/resources/manager/js/warehouse/commodity/manufacturer/add_manufacturer.js"></script>
<!-- END CUSTOMIZED LIB -->
