            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <ol class="breadcrumb" style="margin: 0;">
                        ...
                        <li class="active">Add Courier Shipping Area</li>
                    </ol>
                </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-2 col-md-offset-2">
                                <a id="add_courier_shipping_area" class="btn btn-success btn-lg btn-block">Save</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="/resources/manager/js/warehouse/logistic/courier/shipping_area/add_courier_shipping_area.js"></script>
<!-- END CUSTOMIZED LIB -->
