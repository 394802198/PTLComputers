...
<!--                        <a class="btn btn-xs btn-primary" id="oneClickCompletePendingOrders">-->
<!--                            One Click Complete Pending Orders-->
<!--                        </a>-->
                    </li>
                </ol>
            </div>
            <div class="col-md-12" style="padding:50px;">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="input-group">
                                <?php $orderStatus = array('pending'=>'Pending', 'processing'=>'Processing', 'waiting_for_shipment'=>'Waiting For Shipment', 'shipped'=>'Shipped', 'completed'=>'Completed', 'cancelled'=>'Cancelled') ?>
                                <select name="order_status" class="form-control" data-search>
                                    ...
                                    <?php foreach ($orderStatus as $orderState) { ?>
                                        <?php if( $ciPagination != null && $ciPagination->model != null && $ciPagination->model->order_status != null && ( strcasecmp( $ciPagination->model->order_status,$orderState )==0 && $ciPagination->model->order_status!='NULL' ) ) { ?>
                                            <option value="<?php echo $orderState ?>" selected><?php echo $orderState ?></option>
                                        <?php } else { ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-10 col-md-offset-2">
                            <a href="javascript:void(0);" id="search_btn" class="btn btn-sm btn-info">
            ...
            <div class="col-md-12">
                <?php if($_SESSION['manager']['role']=='administrator'){ ?>
                    <a href="javascript:void(0);" id="delete_order_btn" class="btn btn-sm btn-info" style="color:#FFF;">
                    ...
                    <?php if( isset( $ciPagination ) && $ciPagination->content != null ){ ?>
                        ...
                        <?php foreach ( $ciPagination->content as $index => $order ):?>
                            <tr class="<?php echo $index%2==0 ? 'info' : '' ?>">
                                ...
                                <td>
                                    <a href="/manager/remarketing/order/edit/id/<?php echo $order->id ?>" class="btn btn-xs btn-info">
                                        <?php echo $order->id ?>
...
<!-- Modal -->
<div class="modal fade" id="oneClickCompletePendingOrdersModal" tabindex="-1" role="dialog" aria-labelledby="oneClickCompletePendingOrdersModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="oneClickCompletePendingOrdersModalLabel">One Click Complete Pending Orders</h4>
            </div>
            <div class="modal-body">
                Sure to one click complete pending orders?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Wait a minute</button>
                <button type="button" class="btn btn-warning" id="oneClickCompletePendingOrdersConfirm">One Click Complete</button>
            </div>
        </div>
    </div>
</div>
...
<script src="/resources/manager/js/remarketing/order/view_order_by_page.js"></script>
<!-- END CUSTOMIZED LIB -->